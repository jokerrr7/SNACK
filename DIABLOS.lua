...
if plugin.DIABLOS and msg then
pre_msg = plugin.DIABLOS(msg)
end
end
end
...
os.execute('wget https://raw.githubusercontent.com/AhmedElsayed111/snaack/main/DIABLOS.lua')
...
send(msg.chat_id_, msg.id_,'⏎︙  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..DIABLOS..'\n⏎︙  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."DIABLOS:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."DIABLOS:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DIABLOS:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."DIABLOS:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."DIABLOS:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
local DRAGONChengName = database:get(bot_id.."DIABLOS:Cheng:Name"..data.id_)
...
if data.id_ then 
if data.id_ ~= bot_id then
local DRAGONChengUserName = database:get(bot_id.."DIABLOS:Cheng:UserName"..data.id_)
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DRAGONChengPhoto = database:get(bot_id.."DIABLOS:Cheng:Photo"..data.id_)
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ⏎︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:DIABLOS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:DIABLOS:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DIABLOS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"⏎︙ تم مسح الرد من ردود المتعدده")
database:del(bot_id..'botss:DIABLOS:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:DIABLOS:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:DIABLOS:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:DIABLOS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:DIABLOS:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:DIABLOS:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:DIABLOS:List:Rd:Sudo")
end
...
data,res = https.request('https://banda40.ml/snack/audios.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
database:set(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:DIABLOS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"⏎︙ارسل الان الكلمه لمسحها ")
end
if text then  
local test = database:get(bot_id.."botss:DIABLOS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DIABLOS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DIABLOS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:DIABLOS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"⏎︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:DIABLOS:Add:Rd:Sudo:Text2"..text)   
...
if text == "غنيلي" then
data,res = https.request('https://banda40.ml/snack/audios.php')
if res == 200 then
...
DIABLOS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DIABLOS)
