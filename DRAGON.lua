...
if res ~= 200 then
print('\27[0;31m≪━━━━━━SOURCE SNACK ☬━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━SOURCE SNACK ☬━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━SOURCE SNACK ☬━━━━━━≫ ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "≪━━━━━━SOURCE SNACK ☬━━━━━━≫ ≪━━━━━━SOURCE SNACK ☬━━━━━━≫ ━"
exit 1
fi
if [ ! $token ]; then
echo "≪━━━━━━SOURCE SNACK ☬━━━━━━≫ ≪━━━━━━SOURCE SNACK ☬━━━━━━≫ ━ ━"
...
local UserName = (data.username_ or "TEAM_SNACK")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇SOURCE SNACK ☬.")  
...
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'TEAM_SNACK')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
usertext = '\n ⏎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAM_SNACK')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEAM_SNACK')..') \n ⏎︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⏎︙ العضو : {["..data.first_name_.."](T.ME/TEAM_SNACK)}\n ⏎︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⏎︙ عذرا » {["..data.first_name_.."](T.ME/TEAM_SNACK)}\n ⏎︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = 'قناه السورس', url="t.me/TEAM_SNACK"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEAM_SNACK')..') \n ⏎︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TEAM_SNACK')..') \n ⏎︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر البوبعام")
return false 
end
...
send(msg.chat_id_, msg.id_, " ⏎︙ لا يمكنك حظر البوب\n")
return false 
end
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'TEAM_SNACK')..')'
status  = '\n ⏎︙ تم حظره عام من الجروبات'
...
if tonumber(result.sender_user_id_) == tonumber(1535803411) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع كتم البوبعام")
return false 
end
...
if result.id_ == tonumber(1535803411) then
send(msg.chat_id_, msg.id_, " ⏎︙ لا يمكنك كتم البوب\n")
return false 
end
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'TEAM_SNACK')..')'
status  = '\n ⏎︙ تم كتمه عام من الجروبات'
...
local TextE = "\n≪━━━━━━SOURCE SNACK ☬━━━━━━≫\n ⏎︙ علامة تعني { ✔️ } ملف مفعل\n ⏎︙ علامة تعني { ✖ } ملف معطل\n ⏎︙ قناة سورس سناك ↓\n".." ⏎︙ [اضغط هنا لدخول](t.me/TEAM_SNACK) \n"
local NumFile = 0
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⏎︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAM_SNACK')..')'
status  = '\n ⏎︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⏎︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⏎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAM_SNACK')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TEAM_SNACK')..')'..'\n ⏎︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."TEAM_SNACK:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."TEAM_SNACK:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."TEAM_SNACK:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TEAM_SNACK:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⏎︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."TEAM_SNACK:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."TEAM_SNACK:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAM_SNACK')..')'
local iduser = result.sender_user_id_
...
{
{text = '☉ SOURCE SNACK ☬ ☉', url="t.me/TEAM_SNACK"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@TEAM_SNACK','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
