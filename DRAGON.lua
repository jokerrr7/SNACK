...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/source_Qursan/2107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '『 𝘽𝘼𝙍𝙇𝙊 』', url="t.me/source_Qursan"}}, 
{{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↱ ⁞ ᴅᴇᴠᴇʟᴏᴘᴇʀ ⁞ ↰',url="t.me/S_79_Q"}},{{text = '↱ ⁞ ᴅᴇᴠᴇʟᴏᴘᴇʀ ⁞ ↰',url="t.me/source_Qursan"}},
{{text = '↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰',url="t.me/source_Qursan"}},
{{text = ' ↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫ ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/S_79_Q"},
},
{{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [WELCOME TO BLACK](http://t.me/source_Qursan)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '↱ ⒷⓁⒶⒸⓀ  ↰', url="t.me/S_79_Q"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/FTAGC/12&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
