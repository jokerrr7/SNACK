...
sudo_users = {SUDO,1765160742,1420036323,1535803411}   
...
local UserName = (data.username_ or "UU_SNAK")
...
send(msg.chat_id_,0, " • عذرا > {["..data.first_name_.."](T.ME/UU_SNAK)}\n • عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = 'المبرمج نيمار', url="t.me/Boster7"}},  
{{text = 'قناه السورس', url="t.me/UU_SNAK"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' • بواسطه > ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'UU_SNAK')..') \n • تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1420036323) then  
...
if tonumber(userid) == tonumber(1420036323) then  
send(msg.chat_id_, msg.id_, " • لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(userid) == tonumber(1535803411) then  
send(msg.chat_id_, msg.id_, " • لا تسطيع حظر البوب عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1535803411) then  
send(msg.chat_id_, msg.id_, " • لا تسطيع كتم البوب عام")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n • لعضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SNAK')..')'
status  = '\n • تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n • العضو > '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n • العضــو > ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SNAK')..')'
...
keyboard.inline_keyboard = {  
{{text = 'المبرمج جوكر', url="t.me/eljo_ker_m"}},
{{text = '- لشراء الالعاب رسلني  .',url=>"https://t.me/UU_0P"}},
...
database:set(bot_id.."UU_SNAK:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."UU_SNAK:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."UU_SNAK:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."UU_SNAK:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⏎︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."UU_SNAK:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."UU_SNAK:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'UU_SNAK')..')'
local iduser = result.sender_user_id_
...
{
{text = '☉ SOURCE SNACK ☬ ☉', url="t.me/UU_SNAK"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
