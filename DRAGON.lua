...
sudo_users = {SUDO,1765160742,1465250253,1325450849}   
...
var = true  
elseif tonumber(user_id) == tonumber(1325450849) then
var = true  
...
{{text = 'المبرمج البوب', url="t.me/UU_0px"}}, 
...
if tonumber(result.sender_user_id_) == tonumber(1325450849) then  
...
if tonumber(userid) == tonumber(1325450849) then  
...
keyboard.inline_keyboard = {  
{{text = 'المبرمج جوكر', url="t.me/eljo_ker_m"}},
{{text = '- لشراء الالعاب رسلني  .',url=>"https://t.me/UU_0px"}},
