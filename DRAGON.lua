...
------by-Joker---- by--- Joker ------byJoker-------power-----soucer----Joker
...
send(msg.chat_id_, msg.id_,'  ◉ اصدار سورس بلاك{ 6v ◉}')
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BLACK_TEAM_4' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس بلاك ادخل وتابع الجديد](t.me/BLACK_TEAM_4)
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗕𝗟𝗔𝗖𝗞', url="t.me/BLACK_TEAM_4"}}, 
{{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↱ ⁞ ᴅᴇᴠᴇʟᴏᴘᴇʀ ⁞ ↰',url="t.me/UUOUOU_7"}},
{{text = '↱⁞ ᴅᴇᴠᴇʟᴏᴘᴇʀ ⁞ ↰',url="t.me/V_P_E"}},
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'مبرمج السورس\n['..result.first_name_..'](t.me/V_P_E)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'Telegram Developer\n['..result.first_name_..'](t.me/UUOUOU_7)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/UUOUOU_7"},
...
send(msg.chat_id_, msg.id_, "لا يمكنني كتم مطور السورس عام")
return false 
end
...
if text == ("رفع بلاك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع بلاك@(.*)$") and Sudo(msg) then
...
if text and text:match("^رفع بلاك(%d+)$") and Sudo(msg) then
...
if text == ("تنزيل بلاك") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل بلاك@(.*)$") and Sudo(msg) then
...
if text and text:match("^تنزيل بلاك(%d+)$") and Sudo(msg) then
...
------by-Joker---- by--- Joker ------byJoker-------power-----soucer----Joker adddev2 sudog
...
if text == "بوت" then
local Namebot = (database:get(bot_id..'Name:Bot') or 'يابوت') 
local DRAGON_Msg = { 
'اسمي  '..Namebot..' تفضل',
'اسمي '..Namebot..'تدلل️',
} 
...
send(msg.chat_id_,msg.id_, '[انت المطور](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن ](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل](t.me/BLACK_TEAM_4)')
return false
end
...
keyboard.inline_keyboard = {
{
{text = 'العاب السورس', callback_data="/mute-name"},{text = 'المميزات', callback_data="/change-photo"},
},
{
{text = 'الالعاب المتطوره', callback_data="/sofi"},
},
{
...
------by-Joker---- by--- Joker ------byJoker-------power-----soucer----Joker------by-Joker---- by--- Joker ------byJoker-------power-----soucer----Joker
