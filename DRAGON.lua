...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/hadohu/sa/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1765160742,33333333333333,7777777777777777777777,1965297568}   
...
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'المطور الاساسي'  
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'المطور'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local function sendphoto(chat_id, reply_to_message_id, disable_notification, from_background, reply_markup, video, duration, width, height, caption, cb, cmd)    
...
{
{text = '↱ ⁞ ᴅᴇᴠᴇʟᴏᴘᴇʀ ⁞ ↰', url="http://t.me/"..sudos.UserName},
},
{
{text = '  ↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫'   ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"},
},
}
...
os.execute('wget https://raw.githubusercontent.com/jokerrr7/SNACK/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BLACK_TEAM_4/2107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,'  ◉ اصدار سورس بلاك{ 3x ◉}')
end
if text == '↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس بلاك ادخل وتابع الجديد](t.me/BLACK_TEAM_4)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'BLACK', url="t.me/BLACK_TEAM_4"}}, 
{{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BLACK_TEAM_4/2107' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس Barlo0o ادخل وتابع الجديد](t.me/BLACK_TEAM_4)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'BLACK', url="t.me/BLACK_TEAM_4"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
  ◉ من أحسن السورسات على التليجرام سورس بلاك  ◉
...
{
{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫ ↯', url = "https://t.me/"..data.username_.."?startgroup=new"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,0,"  ◉ الـعـضو  : {["..data.first_name_.."](T.ME/BLACK_TEAM_4)}\n  ◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("@[%a%d_]+") or text and text:match("@(.+)") then    
if database:get(bot_id.."lock:user:name"..msg.chat_id_) == "del" and not Special(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."lock:user:name"..msg.chat_id_) == "ked" and not Special(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("[Jj][Oo][Ii][Nn][Cc][Hh][Aa][Tt]") or text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↱ ⁞ ᴅᴇᴠᴇʟᴏᴘᴇʀ ⁞ ↰',url="t.me/UUOUOU_7"}},{{text = '↱ ⁞ ᴅᴇᴠᴇʟᴏᴘᴇʀ ⁞ ↰',url="t.me/V_P_E"}},
{{text = '↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰',url="t.me/BLACK_TEAM_4"}},
{{text = ' ↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫ ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = 1965297568,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '• داد بلاك مطور سورس بلاك لو حابب تتواصل معاه اضغط علي الزر •\n['..result.first_name_..'](t.me/NH_OA)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/V_P_E"},
},
{{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1965297568, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end

if text == 'الجوكر' or text == 'جوكر' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'Telegram Developer\n['..result.first_name_..'](t.me/barlo0o_bot)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/UUOUOU_7"},
},
{{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1765160742, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end

if text == 'اتماهـ' or text == 'لتتات' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/BLACK_TEAM_4"},
},
{{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'اتناترلتت' or text == 'لنتهنللب' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
...
if text == "اتاتننتتتت" then
if not DevSoFi(msg) then
local Text = [[
¤ سعر تنصيب البوت • 🌝
¤ علي سورس بلاك (20) فقط • 💸
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰', url="t.me/barlo0o_bot"}},
{{text = '★ ↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫ • ★', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jdjie1/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jndjkdkd/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/y_giu/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/agany001/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jfudb637/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
"اكتب تاريخ مستحيل تنساه ",
  ...
  "فُرصه تتمنى لو أُتيحت لك ؟ ",
   "لي سورس بلاك رقم 1 علي التليجرام؟ ",
  "شيء مستحيل ترفضه ؟. ",
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [WELCOME TO BLACK](http://t.me/BLACK_TEAM_4)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '↱ ⒷⓁⒶⒸⓀ  ↰', url="t.me/BLACK_TEAM_4"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》', url="t.me/BLACK_TEAM_4"}}, 
{{text = '★ ↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫ • ★' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BLACK_TEAM_4/2107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب بلاك' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
  ◉ اهلا في قائمه الالعاب المتطوره سورس بلاك  ◉ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[اتبع الازرار للتواصل مع](t.me/UUOUOU_7)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local BLACK_TEAM_4 = database:get(bot_id..'text:ch:user')
if BLACK_TEAM_4 then
send(msg.chat_id_, msg.id_,'['..BLACK_TEAM_4..']')
else
...
send(msg.chat_id_, msg.id_, "◉ لا تسطيع كتم مبرمج السورس عام️")
return false 
end
...
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج بلاك عام 🚫")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1765160742) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم بلاك عام لانه هكر 🌚😹")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/hadohu/sa/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/hadohu/sa/main/File_Bot/"..file)
if res == 200 then
...
if text == ("مسح قائمه بلاك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n  ◉ تم مسح قائمه بلاك')
return false
end

if text == 'قائمه بلاك' and Sudo(msg) then
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^رفع منشئ (%d+)$") and BasicConstructor(msg) then
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^تنزيل منشئ @(.*)$") and BasicConstructor(msg) then
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^تنزيل منشئ (%d+)$") and BasicConstructor(msg) then
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰if text == ("رفع بلاك") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
database:sadd(bot_id.."Dev:SoFi:2", result.sender_user_id_)
...
if text and text:match("^رفع بلاك @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع بلاك @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⌯︙ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^رفع بلاك (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع بلاك (%d+)$")
database:sadd(bot_id.."Dev:SoFi:2", userid)
Reply_Status(msg,userid,"reply","⌯︙ تم ترقيته مطور ثانوي في البوت")  
return false 
end
if text == ("تنزيل بلاك") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
database:srem(bot_id.."Dev:SoFi:2", result.sender_user_id_)
...
if text and text:match("^تنزيل بلاك @(.*)$") and SudoBot(msg) then
local username = text:match("^تنزيل بلاك @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:SoFi:2", result.id_)
...
if text and text:match("^تنزيل بلاك (%d+)$") and SudoBot(msg) then
local userid = text:match("^تنزيل بلاك (%d+)$")
database:srem(bot_id.."Dev:SoFi:2", userid)
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  ◉ الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..')'
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^تقيد @(.*)$") and Mod(msg) then
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^تقيد (%d+)$") and Mod(msg) then
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^الغاء تقيد @(.*)$") and Mod(msg) then
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^الغاء تقيد (%d+)$") and Mod(msg) then
...
' }\n'..'  ◉  الايدي بالصوره  ↜:{ '..idph..
' }\n'..'  ◉  الرفع  ↜:{ '..setadd..
' }\n'..'  ◉  الحظر  ↜:{ '..banm..' }\n\n  ◉═───═❲[↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰ ](t.me/BLACK_TEAM_4)❳═───═  ◉\n  ◉ قناة سورس بلاك↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰\n [ ❲[˹《♡ 𝘽𝘼??𝙇𝙊 ♡》˼ ](t.me/BLACK_TEAM_4)❳](t.me/BLACK_TEAM_4) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس بلاكو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
if video then 
sendphoto(msg.chat_id_, msg.id_, 0, 1, nil,video)
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
end
if anemi then 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/comxnxp/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'كسمهم' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/comxnxp/19&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/comxnxp/21&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Qtdao/16&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
end --الكود حصري سورس بلاكيعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك.. ◉♥️](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/BLACK_TEAM_4)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤 ◉](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..??](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد .. ◉💕](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/BLACK_TEAM_4)')
return false
end
end
end
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then  
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
[🎯 ألعاب سورس بلاك الأفضل في التليجرام •]
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match('^صلاحياته @(.*)') then   
...
{
{text = '𓆩BLACK𓆪', url="t.me/BLACK_TEAM_4"},
},
{{text = '↬⁞ ᴀᴅᴅ ᴛʜᴇ ʙᴏᴛ ᴛᴏ ʏᴏụʀ ɢʀᴏụᴘ ⁞↫' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
{
{text = '《♡ ??𝘼𝙍𝙇𝙊》', url="t.me/BLACK_TEAM_4"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if textnot database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:del(bot_id..'Spam:Texting'..msg.sender_user_id_) 
end
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if textdatabase:get(bot_id.."Del:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
end 
...
↱ ⁞ ⒷⓁⒶⒸⓀ ⁞ ↰
if texttext:match("[hH][tT][tT][pP][sT]") or text and text:match("[tT][eE][lL][eE][gG][rR][aA].[Pp][Hh]") or text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa].[Pp][Hh]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
end  
