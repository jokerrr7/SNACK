...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SNACK.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SNACK -X kill
screen -S SNACK ./SNACK
done
]])  
file:close()
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/AhmedElsayed111/snaack/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1557685494,1745864543,972295724}   
...
send_api = "https://api.telegram.org/bot"..
 local url = send_api..'/sendMessage?chat_id=' .. chat_id .. '&text=' .. URL.escape(text) if reply_to_message_id ~= 0 then url = url .. '&reply_to_message_id=' .. reply_to_message_id  end if markdown == 'md' or markdown == 'markdown' then url = url..'&parse_mode=Markdown' elseif markdown == 'html' then url = url..'&parse_mode=HTML' end return s_api(url)  
end
...
local UserName = (data.username_ or "TEM_DIABLOS")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝐒𝐎𝐔𝐑𝐂𝐄 DIABLOS☬.")  
...
if plugin.SNACK and msg then
pre_msg = plugin.SNACK(msg)
end
end
end
...
SourceDRAGONr = '• مرحبا يا صديقي انا بوت اسمي ديابلو \n • اختصاصي حمايه مجموعاتك من الاسبام والاشياء التي تضر بها .\n • احتوي علي العديد من المميزات منها " الاغاني ، الافلام ، الروايات ، الالعاب\n • كل ما عليك فعله رفعي مشرف بمجموعتك . \n • واكتب كلمه " تفعيل " .\n'
end 
...
os.execute('rm -rf SNACK.lua')
os.execute('wget https://raw.githubusercontent.com/AhmedElsayed111/snaack/main/SNACK.lua')
send(msg.chat_id_, msg.id_,' ⏎︙ تم تحديث السورس \n ⏎︙ لديك اخر اصدار لسورس ديابلو\n ⏎︙ الاصدار » {v2.5.9}')
dofile('SNACK.lua')  
end
if text == 'الاصدار ✪' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⏎︙ اصدار سورس ديابلو \n ⏎︙ الاصدار »{v2.5.9}')
end
...
send(msg.chat_id_, msg.id_,'⏎︙  عدد الجروبات الان » { '..#group..' }'..DRAGONk..''..SNACK..'\n⏎︙  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_,0, " ⏎︙ عذرا » {["..data.first_name_.."](T.ME/TEM_DIABLOS)}\n ⏎︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."SNACK:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SNACK:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."SNACK:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."SNACK:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SNACK:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SNACK:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SNACK:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SNACK:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."SNACK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SNACK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."SNACK:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."SNACK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SNACK:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⏎︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "TEM_DIABLOS")..")\n⏎︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SNACK:teh"..msg.chat_id_).."} بجانب اسمك\n⏎︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local DRAGONChengName = database:get(bot_id.."SNACK:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DRAGONChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DRAGONChengName..']')
database:del(bot_id.."SNACK:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
...
database:set(bot_id.."SNACK:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DRAGONChengUserName = database:get(bot_id.."SNACK:Cheng:UserName"..data.id_)
if not data.username_ then 
if DRAGONChengUserName then 
send(msg.chat_id_, msg.id_, 1, "مسح معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DRAGONChengUserName..']')
database:del(bot_id.."SNACK:Cheng:UserName"..data.id_) 
end
end
...
database:set(bot_id.."SNACK:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DRAGONChengPhoto = database:get(bot_id.."SNACK:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DRAGONChengPhoto then 
send(msg.chat_id_, msg.id_, "مسح كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."SNACK:Cheng:Photo"..data.id_) 
end
end
...
database:set(bot_id.."SNACK:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
{{text = 'مطور السورس', url="t.me/H_S_A_7"}},
{{text = 'قناه السورس', url="t.me/TEM_DIABLOS"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TEM_DIABLOS')..') \n ⏎︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(userid) == tonumber(972295724) then  
send(msg.chat_id_, msg.id_, " ⏎︙ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/AhmedElsayed111/snaack/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⏎︙ اهلا بك في متجر ملفات ديابلو\n ⏎︙ ملفات السورس ↓\n܀•••••••••••••••••܀\n\n"
local TextE = "\n܀•••••••••••••••••܀\n ⏎︙ علامة تعني { ✔️ } ملف مفعل\n ⏎︙ علامة تعني { ✖ } ملف معطل\n ⏎︙ قناة سورس ديابلو ↓\n".." ⏎︙ [اضغط هنا لدخول](t.me/TEM_DIABLOS) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/AhmedElsayed111/snaack/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SNACK.lua')  
else
send(msg.chat_id_, msg.id_," ⏎︙ عذرا الملف لايدعم سورس ديابلو \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⏎︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_DIABLOS')..')'
status  = '\n ⏎︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⏎︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⏎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_DIABLOS')..')'
...
if text == 'العاب ديابلو' or text == 'العاب خارقه' or text == 'العاب متطوره' then  
local Text = [[  
اهلا في قائمه الالعاب المتطوره سورس ديابلو 🎮
...
' }\n'..' ⏎︙  الايدي بالصوره » { '..idph..
' }\n'..' ⏎︙  الرفع » { '..setadd..
' }\n'..' ⏎︙  الحظر » { '..banm..' }\n\n܀•••••••••••••••••܀\n ⏎︙ قناة سورس ديابلو ↓\n [•┇𝐒𝐎𝐔𝐑𝐂𝐄 DIABLOS.](t.me/TEM_DIABLOS) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ⏎︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:SNACK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:SNACK:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SNACK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"⏎︙ تم مسح الرد من ردود المتعدده")
database:del(bot_id..'botss:SNACK:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:SNACK:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:SNACK:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:SNACK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:SNACK:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:SNACK:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:SNACK:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:SNACK:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:SNACK:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:SNACK:List:Rd:Sudo")
end
...
database:set(bot_id.."TEM_DIABLOS:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."TEM_DIABLOS:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."TEM_DIABLOS:insta_bot"..msg.chat_id_) == "open" then
local Textni = text:match("^معلومات (.*)$")
data,res = https.request('https://blackhackk.ml/tokenj.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
database:set(bot_id.."TEM_DIABLOS:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⏎︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."TEM_DIABLOS:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."TEM_DIABLOS:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس ديابلو يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:SNACK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"⏎︙ارسل الان الكلمه لمسحها ")
end
if text then  
local test = database:get(bot_id.."botss:SNACK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SNACK:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SNACK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SNACK:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SNACK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:SNACK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SNACK:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"⏎︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:SNACK:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:SNACK:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:SNACK:Add:Rd:Sudo:Text2"..text)   
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'اسمي الكيوت ديابلو🌚💕.')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_DIABLOS')..')'
local iduser = result.sender_user_id_
...
{
{text = '☉ 𝐒𝐎𝐔𝐑𝐂𝐄 DIABLOS ☉', url="t.me/TEM_DIABLOS"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == "غنيلي" then
data,res = https.request('https://blackhackk.ml/tokenj.php')
if res == 200 then
...
if text == "اي رئيك فيه" or text == "اي رئيك في" or text == "شنو رئيك بهذا" or text == "بوت تعرفه" or text == "اشتمه" or text == "شنو رايك بهذ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لا محترم وابن ناس ."," حكاك وبتاع نسوان","ابن وسخه محبوش"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "اي رئيك فيها" or text == "اشتمها" or text == "بوت تعرفها" or text == "قول رئيك فيها" or text == "شنو رايك بهاي" or text == "شنو رايك بهايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اجمل بنت هنا","بنت وسخه مش بطقها .","حقيره ومنتكبره 😶😂"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "هينه" or text == "اشتم" or text == "هيني" or text == "رزلي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مالك يبنلوسخه محدش مالي عينك ","ميستاهل اتعب روحي واشتمه لانه عار","عوفه يروحي هاذا طيز 🤣"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
*❿◂ اوامر الاعضاء .*
*܀•••••••••••••••••܀*
➫ .[•SOURCE snaack . ](t.me/TEM_DIABLOS)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ديابلو')
...
SNACK = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SNACK)
